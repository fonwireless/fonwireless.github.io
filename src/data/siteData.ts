export const siteData = {
  ...
  addressMapLink: "https://www.google.com/maps/place/Fonwireless/data=!4m2!3m1!1s0x0:0xfbfd53ae684863e0?sa=X&ved=1t:2428&ictx=111",
};
...
export const features = [
  {
    title: "Mobile Repair",
    description: "Fast diagnostics and reliable repairs for screens, batteries, charging ports, and more.",
    icon: "ri-smartphone-line",
  },
  {
    title: "Accessories",
    description: "Cases, chargers, tempered glass, and cables selected for durability and fit.",
    icon: "ri-headphone-line",
  },
  {
    title: "Buy / Sell Used Phones",
    description: "Browse tested pre-owned phones or sell your device for a competitive local offer.",
